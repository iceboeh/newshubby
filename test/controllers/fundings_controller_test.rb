...
class FundingsControllerTest < ActionController::TestCase
  ...
  test "should create funding" do
    assert_difference('Funding.count') do
      post :create, funding: { amount: @funding.amount, date: @funding.date, investment_type: @funding.investment_type, name: @funding.name, newsroom_id: @funding.newsroom_id }
    end
  ...
  test "should update funding" do
    patch :update, id: @funding, funding: { amount: @funding.amount, date: @funding.date, investment_type: @funding.investment_type, name: @funding.name, newsroom_id: @funding.newsroom_id }
    assert_redirected_to funding_path(assigns(:funding))
  end
