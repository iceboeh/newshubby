...
class DistributionsControllerTest < ActionController::TestCase
  ...
  test "should create distribution" do
    assert_difference('Distribution.count') do
      post :create, distribution: { comments: @distribution.comments, geography: @distribution.geography, niche: @distribution.niche }
    end
  ...
  test "should update distribution" do
    patch :update, id: @distribution, distribution: { comments: @distribution.comments, geography: @distribution.geography, niche: @distribution.niche }
    assert_redirected_to distribution_path(assigns(:distribution))
  end
